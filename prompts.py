...
problem = """
You continue to scroll through Pinterest, exploring popular pins and notice some pins appear as "Related Pins," requiring you to navigate through multiple pins to access them.
To tackle this obstacle, you decide to explore the "Related Pins" of each popular pin up to a certain depth.
You do so by exploring as deeply as possible before backtracking to the previous pin and exploring other unexplored branches.
Write a function that takes in a list of (pin_id, related_pin_id) pairs, along with two integers: k and depth.
The function should return the k pins based on and ordered by the given criteria, considering the exploration depth.
...
## Example 1
k=6, depth=2
get_k_popular_pins(pins, k, depth) =>  [1123, 643, 987, 221, 563, 101]

## Example 2
k=6, depth=1
#get_k_popular_pins(pins, k, depth) => [1123, 643, 221, 563, 987, 101]

## Example 3
k=6, depth=0
#get_k_popular_pins(pins, k, depth) => [1123, 221, 643, 563, 987, 101]
"""
